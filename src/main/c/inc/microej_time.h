 ...
 * 
 * To implement this API the use of a hardware timer is recommended. The validation is done with the Core Engine Test Suite: https://github.com/MicroEJ/VEEPortQualificationTools/tree/master/tests/core/
 * 
